...
function makeTitle (title, lang) {
  ...
  if (basicsChallenges.includes(title)) {
    return 'Basics: ' + grammarized
  } else if (advancedChallenges.includes(title)) {
    return 'Advanced: ' + grammarized
  }
