...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  function updateProgressCounters(data) {
    ...
    var basicsLabel = document.querySelector('.basics-progress-section .section-label')
    if (basicsLabel) {
      basicsLabel.textContent = 'Challenges completed: ' + basicsCompleted + '/' + basicsChallenges.length
    }
    ...
    var advancedLabel = document.querySelector('.advanced-progress-section .section-label')
    if (advancedLabel) {
      advancedLabel.textContent = 'Challenges completed: ' + advancedCompleted + '/' + advancedChallenges.length
    }
  }
