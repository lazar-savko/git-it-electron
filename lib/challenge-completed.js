...
var completed = function (challenge) {
  document.addEventListener('DOMContentLoaded', function (event) {
    ...
    // Only add completed class to challenges that are actually in the current sidebar
    var sidebarChallenges = document.querySelectorAll('.challenge-item')
    sidebarChallenges.forEach(function(element) {
      var challengeId = element.id
      if (data.contents[challengeId] && data.contents[challengeId].completed) {
